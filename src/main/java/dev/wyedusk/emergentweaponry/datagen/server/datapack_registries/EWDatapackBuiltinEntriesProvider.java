...
public class EWDatapackBuiltinEntriesProvider extends DatapackBuiltinEntriesProvider {
    public EWDatapackBuiltinEntriesProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
    ...
    private static RegistrySetBuilder bootstrapRegistries() {
        return new RegistrySetBuilder()
                ...
                .add(Registries.DAMAGE_TYPE, context -> {
                    context.register(Contents.DamageTypes.ESSENCE_TRIDENT_RIPTIDE, new DamageType(
                            Contents.DamageTypes.ESSENCE_TRIDENT_RIPTIDE.location().toLanguageKey(),
                            DamageScaling.NEVER,
                            0.0f,
                            DamageEffects.HURT,
